...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '216b160b46d14e7d8cc8fa2753209872,en:d79f200d2678408c885842d2fe070769',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.think-zen.top', // 网站地址
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 1440, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  ...
  CUSTOM_EXTERNAL_CSS: ['/styles/custom-styles.css'], // e.g. ['http://xx.com/style.css','http://xx.com/style.css']
